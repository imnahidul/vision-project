...
const Categories = () => {
  ...
  const fetchCategories = async () => {
    setLoading(true);
    try {
      const response = await axios.get("https://vision-project-server.onrender.com/api/category", {
        headers: {
    ...
    try {
      if (editCategory) {
        const response = await axios.put(
          `https://vision-project-server.onrender.com/api/category/${editCategory}`,
        ...
        const response = await axios.post(
          "https://vision-project-server.onrender.com/api/category/add",
          { categoryName, categoryDescription },
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://vision-project-server.onrender.com/api/category/${id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
          },
