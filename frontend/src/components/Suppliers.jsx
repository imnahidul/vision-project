...
////////////////////////////Supplier jsx start/////////////////////
  const fetchSuppliers = async () => {
    setLoading(true);
try{
  const response = await axios.get("https://vision-project-server.onrender.com/api/supplier",{
    headers: {
...
const handleSubmit = async (e) => {
    ...
    if(editSupplier){
     try {
        const response = await axios.put(
            `https://vision-project-server.onrender.com/api/supplier/${editSupplier}`,
            formData,
            {
                headers: {
     ...
     try {
        const response = await axios.post(
            "https://vision-project-server.onrender.com/api/supplier/add",
            formData,
            {
                headers: {
 ...
 try {
   const response = await axios.delete(`https://vision-project-server.onrender.com/api/supplier/${id}`,
...
//         `https://vision-project-server.onrender.com/api/supplier/${id}`,
//         {
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
//           },
