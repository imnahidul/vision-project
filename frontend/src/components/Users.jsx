...
//useEffect(() => {
  const fetchUsers = async () => {
    setLoading(true);
try{
  const response = await axios.get("https://vision-project-server.onrender.com/api/users",{
    headers: {
...
const handleSubmit = async (e) =>{
        ...
        //     // const response = await axios.post("https://vision-project-server.onrender.com/api/category/add",
        //     const response = await axios.put(`https://vision-project-server.onrender.com/api/category/${editCategory}`,
        ...
        //     } else {
                ...
                //     }else{
          const response = await axios.post("https://vision-project-server.onrender.com/api/users/add",
           formData,
            {
            headers: {
              //not match 
  ...
  if(confirmDelete) {
 try {
   const response = await axios.delete(`https://vision-project-server.onrender.com/api/users/${id}`,
